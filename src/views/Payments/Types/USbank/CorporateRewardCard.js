  ...
  validation = () => {
    ...
    if (isPlasticSelected) {
      if (
        ...
        validation['plasticFundingCardID'] =
          'Plastic FundingCard ID is required';
        valid = false;
      } else if (plasticFundingCardID && plasticFundingCardID.length !== 10) {
        validation['plasticFundingCardID'] =
          'Plastic FundingCard ID must be of 10 digits';
        valid = false;
      }
      ...
      if (
        ...
        validation['plasticFundingCardPassCode'] =
          'Plastic FundingCard Pass Code is required';
        valid = false;
      } else if (
        plasticFundingCardPassCode &&
        ...
        validation['plasticFundingCardPassCode'] =
          'Plastic FundingCard Pass Code must be of 4 digits';
        valid = false;
      }
    }
    ...
    if (isDigitalSelected) {
      if (
        ...
        validation['digitalFundingCardID'] =
          'Digital FundingCard ID is required';
        valid = false;
      } else if (digitalFundingCardID && digitalFundingCardID.length !== 10) {
        validation['digitalFundingCardID'] =
          'Digital FundingCard ID must be of 10 digits';
        valid = false;
      }
      ...
      if (
        ...
        validation['digitalFundingCardPassCode'] =
          'Digital FundingCard Pass Code is required';
        valid = false;
      } else if (
        digitalFundingCardPassCode &&
        ...
        validation['digitalFundingCardPassCode'] =
          'Digital FundingCard Pass Code must be of 4 digits';
        valid = false;
      }
    }
                  ...
                  <Grid item xs={12} sm={6} className={classes.gridItem}>
                    <Box mx={1} my={2}>
                      <TextField
                        ...
                        label='Plastic FundingCard ID*'
                        placeholder={'Plastic FundingCard ID*'}
                  ...
                  <Grid item xs={12} sm={6} className={classes.gridItem}>
                    <Box mx={1} my={2}>
                      <TextField
                        ...
                        label='Plastic FundingCard Pass Code*'
                        placeholder={'Plastic FundingCard Pass Code*'}
                  ...
                  <Grid item xs={12} sm={6} className={classes.gridItem}>
                    <Box mx={1} my={2}>
                      <TextField
                        ...
                        label='Digital FundingCard ID*'
                        placeholder={'Digital FundingCard ID*'}
                  ...
                  <Grid item xs={12} sm={6} className={classes.gridItem}>
                    <Box mx={1} my={2}>
                      <TextField
                        ...
                        label='Digital FundingCard Pass Code*'
                        placeholder={'Digital FundingCard Pass Code*'}
