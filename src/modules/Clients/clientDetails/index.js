...
class ClientDetails extends Component {
  ...
  getCampaignCountsDetails() {
    ...
    fetchCampaignCountsDetails(clientId).then((response) => {
      if (response.error) {
        return false;
      }
      this.setState({
        campaignCount: response.data && response.data.campaignCount,
        suppliersCount: response.data && response.data.suppliersCount,
      });
    });
  }
  ...
  getClientTokens(client) {
    return fetchClientPortalTokens(client.clientId, client.appType, client.payerTypeId);
  }
                  ...
                  <Grid container>
                    ...
                    <Grid item sm={6} xs={6}>
                      <div className="contactAligns">
                        <img src={Phone} className="svgStyle" />
