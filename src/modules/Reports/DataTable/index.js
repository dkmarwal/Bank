...
import {
    Paper, Box, TableContainer,
    CircularProgress, Table, TableRow, TableBody, TablePagination, TableCell,
...
const ReportView = (props) => {
    const { classes, dataList, totalCount, dataColumns, selectedColumns,
        isLoading, page, rowsPerPage, handlePageChange, handleRowsPerPageChange } = props;
